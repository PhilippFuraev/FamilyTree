 ...
 * @author furae_000
 */
public class addChildWindow extends JDialog {
    ...
    public addChildWindow(FamilyTree tree, int level) {
        super();
        this.tree=tree;
        this.level = level;
        numOfError = -1;
        ...
        next.addActionListener(new addChildWindowListener());
        cancel.addActionListener(new addChildWindowListener());
    ...
    public boolean isOk() {
        ...
        return numOfError;
            ...
            class addChildWindowListener implements ActionListener {

        public void actionPerformed(ActionEvent e) {
            if (e.getSource().equals(next)) {
                if (checkInput() == -1) {
                    result = true;
                    addChildWindow.this.setVisible(false);
                } if (checkInput()==0) {
